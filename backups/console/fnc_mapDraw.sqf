...
*/
    ...
    //Draw waypoints, becauase no one likes framerates anyway
    {
        ...
        _map drawIcon [GVAR(waypointPath),_colour, _pos, _iconSize*0.7,_iconSize*0.7, 0, str _forEachIndex, false, _textSize*0.7];
        _origin = _pos;
    } forEach (_object call FUNC(getWaypoints));
